...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('messages.create_new_user') }}</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('messages.create_new_user') }}</h6>
                    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="border p-3 mb-4 rounded">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nid_no') is-invalid @enderror" name="nid_no" value="{{ old('nid_no') }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr @error('joining_date') is-invalid @enderror" name="joining_date" value="{{ old('joining_date', date('Y-m-d')) }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="salary" class="form-label">{{ __('messages.monthly_salary') }}</label>
                                    <input type="number" step="0.01" class="form-control @error('salary') is-invalid @enderror" name="salary" value="{{ old('salary', $user->salary ?? '0.00') }}">
                        ...
                        <div class="border p-3 rounded">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3" id="area-select" style="display: {{ old('role') == 'Field Worker' ? 'block' : 'none' }};">
                        ...
                        <button type="submit" class="btn btn-primary mt-4">{{ __('messages.create_user') }}</button>
                    </form>
                </div>
            </div>
        </div>
